...
relevant_districts_2018 = df_2018[(df_2018['DISTRICT'].isin(['10', '17', '21', '25', '31'])) & (df_2012['STATE'] == 'Texas')]
...
for district in ['10', '17', '21', '25', '31']:
    ...
    # Plot for 2012
    plt.bar('2012', relevant_districts_2012[relevant_districts_2012['D'] == district]['GENERAL VOTES'].sum(), color='blue', label='2012')
    
    # Plot for 2014
    plt.bar('2014', relevant_districts_2014[relevant_districts_2014['D'] == district]['GENERAL VOTES'].sum(), color='red', label='2014')
    
    # Plot for 2016
    plt.bar('2016', relevant_districts_2016[relevant_districts_2016['D'] == district]['GENERAL VOTES'].sum(), color='green', label='2016')
    
    # Plot for 2018
    plt.bar('2018', relevant_districts_2018[relevant_districts_2018['DISTRICT'] == district]['GENERAL VOTES'].sum(), color='yellow', label='2018')
    
    # Plot for 2020
    plt.bar('2020', relevant_districts_2020[relevant_districts_2020['DISTRICT'] == district]['GENERAL VOTES'].sum(), color='purple', label='2020')
